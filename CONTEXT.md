...
- **Codex Usage Snapshot**: the app-side module that decodes and aggregates Codex usage artifacts, owns partial-host and display-formatting rules, and returns presentation-ready totals and host rows to the menu UI.
